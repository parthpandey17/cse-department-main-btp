    ...
    >
      ...
      <div className="dept-hero">
        <div
          ...
          style={{
            background: `
              radial-gradient(ellipse 70% 90% at 90% 50%, rgba(${dept.colorRgb},0.09) 0%, transparent 60%),
              radial-gradient(ellipse 50% 60% at 10% 80%, rgba(${dept.colorRgb},0.06) 0%, transparent 50%)
            `,
          }}
        />
